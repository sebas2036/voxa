...
const s = StyleSheet.create({
  ...
  ideaRecapText: { fontSize: 13, color: '#2e2e2e', fontStyle: 'italic' },
  sectionLabel: { fontSize: 10, color: '#2a2a2a', letterSpacing: 2, textTransform: 'uppercase', marginBottom: 12 },
  ...
  platformInfo: { flex: 1 },
  platformName: { fontSize: 13, color: '#333', fontWeight: '500' },
  platformNameOn: { color: '#888' },
  platformPreview: { fontSize: 11, color: '#222', marginTop: 2 },
  recBox: { backgroundColor: '#111', borderRadius: 12, borderWidth: 0.5, borderColor: '#1e1e1e', padding: 14, marginTop: 24 },
  recText: { fontSize: 13, color: '#c8b99a55', lineHeight: 20 },
  ...
  scheduleBtnText: { fontSize: 14, color: '#333' },
