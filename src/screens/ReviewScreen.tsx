...
const s = StyleSheet.create({
  ...
  publishBtn: { height: 44, borderRadius: 30, paddingHorizontal: 48, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.1)', borderWidth: 2, borderColor: '#ffffff' },
  publishBtnText: { fontSize: 18, fontWeight: '800', letterSpacing: 3, color: '#ffffff' },
