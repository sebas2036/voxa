...
const s = StyleSheet.create({
  ...
  publishBtn: { height: 48, borderRadius: 30, paddingHorizontal: 52, alignSelf: 'center', alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.15)', borderWidth: 2.5, borderColor: '#ffffff' },
  publishBtnText: { fontSize: 20, fontWeight: '900', letterSpacing: 4, color: '#ffffff', textShadowColor: 'rgba(255,255,255,0.8)', textShadowOffset: { width: 0, height: 0 }, textShadowRadius: 8 },
