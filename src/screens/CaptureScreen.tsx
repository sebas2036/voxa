...
const s = StyleSheet.create({
  safe: { flex: 1 },
  scroll: { padding: 24, paddingTop: 48, paddingBottom: 4 },
  scrollEmpty: { flexGrow: 1, justifyContent: 'space-between' },
  ...
  mediaSection: { marginBottom: 6 },
  mediaLabel: { fontSize: 9, letterSpacing: 3, textTransform: 'uppercase', marginBottom: 4, textAlign: 'center' },
  ...
  bottomSection: { alignItems: 'center', paddingTop: 4, gap: 8 },
  ...
  stickyFooter: { paddingBottom: 16, paddingTop: 4, alignItems: 'center' },
